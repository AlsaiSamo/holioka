...
pkgs.buildLinux {
  ...
  src = pkgs.fetchFromGitHub {
    ...
    repo = "linux";
    rev = "8457bfcd334e1b36c6671c86a4a9dbcfa37864ea"; # v7.0.8-sc7280
    hash = "sha256-dU+UeCr8aVIg226ZnqryPlLuOPsKkKgR/KN/LkvHDGo=";
  };

  # adds defconfig from https://github.com/sc7280-mainline/linux/pull/14
  kernelPatches = [
    {
      name = "fix_defconfig";
      patch = ./kernel_fix_defconfig.patch;
    }
  ];

  # disables things that are automatically inserted for aarch64 kernels
  # (related to tegra and rpi 3 and similar things)
  stdenv = lib.recursiveUpdate pkgs.stdenv {
    hostPlatform.linux-kernel.extraConfig = "";
    hostPlatform.linux-kernel.baseConfig = "spacewar_defconfig";
  };

  # Copied from enchilada's kernel definition
  # Disables a bunch of stuff
  # TODO: disable more stuff to reduce compilation times
  # (some of it is included in the defconfig patch)
