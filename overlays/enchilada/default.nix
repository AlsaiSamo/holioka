...
in rec {
  #Based on gitlab.com/sdm845-mainline/linux/arch/arm64/configs/sdm845.config
  linux_enchilada = pkgsPrev.buildLinux {
    ...
    src = pkgsPrev.fetchFromGitLab {
      ...
      repo = "linux";
      rev = "3e9f7c18a3f681b52b7ea87765be267cd1e8b870";
      hash = "sha256-5oT91pkJEkZUQxgp2Alu1UBDKby7/YbGLjlF0tnAdJQ=";
    };
    ...
    kernelPatches = [
      {
        name = "config_fixes";
        patch = ./config_fixes_610.patch;
      }
    ];

    stdenv = lib.recursiveUpdate pkgsPrev.stdenv {
    ...
    structuredExtraConfig = with lib.kernel; {
      ...
      ACPI_HOTPLUG_MEMORY.tristate = lib.mkForce null;
      BCM2835_MBOX.tristate = lib.mkForce null;
      BCM2835_WDT.tristate = lib.mkForce null;
      CHROMEOS_TBMC.tristate = lib.mkForce null;
      CROS_EC.tristate = lib.mkForce null;
      CROS_EC_I2C.tristate = lib.mkForce null;
      CROS_EC_SPI.tristate = lib.mkForce null;
      CROS_KBD_LED_BACKLIGHT.tristate = lib.mkForce null;
      FSL_MC_UAPI_SUPPORT.tristate = lib.mkForce null;
      MEDIA_ATTACH.tristate = lib.mkForce null;
      MEMORY_HOTREMOVE.tristate = lib.mkForce null;
      MTD_COMPLEX_MAPPINGS.tristate = lib.mkForce null;
      NET_ACT_BPF.tristate = lib.mkForce null;
      PCI_TEGRA.tristate = lib.mkForce null;
      RASPBERRYPI_FIRMWARE.tristate = lib.mkForce null;
      RASPBERRYPI_POWER.tristate = lib.mkForce null;
      SCSI_SAS_ATA.tristate = lib.mkForce null;
      SUN8I_DE2_CCU.tristate = lib.mkForce null;
      TCG_TIS_SPI_CR50.tristate = lib.mkForce null;
      USB_XHCI_TEGRA = lib.mkForce no;
      ZONE_DEVICE.tristate = lib.mkForce null;
  ...
  uboot_enchilada =
    ...
    (pkgsPrev.buildUBoot {
      ...
      # src = pkgsPrev.fetchgit {
      #   #NOTE: commit "Revert "test: smem: add basic smem test""
      #   url = "https://git.codelinaro.org/linaro/qcomlt/u-boot.git";
      #   rev = "bea334ce7578d4cb645cf22d423ec11271feecfe";
      ...
      #Do not use extraPatches, add patches here instead
      # patches = [./uboot_fix_defconfig.patch ./uboot_precompile_dtb.patch];
    })
