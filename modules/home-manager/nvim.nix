{
  ...
  cfg = config.hlk.nvim;
  #TODO: rewrite the entire config?
  #I do not use many features enabled here anymore
in {
  options.hlk.nvim.default.enable = lib.mkEnableOption "default Neovim configuration";
